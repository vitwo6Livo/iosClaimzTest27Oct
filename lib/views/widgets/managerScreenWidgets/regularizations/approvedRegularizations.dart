...
class ApproveRegulizations extends StatefulWidget {
  ApproveRegulizationsState createState() => ApproveRegulizationsState();
}

class ApproveRegulizationsState extends State<ApproveRegulizations> {
