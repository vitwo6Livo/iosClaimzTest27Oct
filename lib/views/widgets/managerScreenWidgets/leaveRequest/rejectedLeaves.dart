...
class RejectedLeaves extends StatefulWidget {
  RejectedLeavesState createState() => RejectedLeavesState();
}

class RejectedLeavesState extends State<RejectedLeaves> {
  ...
  Widget build(BuildContext context) {
    ...
    final provider = Provider.of<LeaveRequestViewModel>(context).rejectedLeaves;
