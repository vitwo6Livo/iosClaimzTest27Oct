...
class RejectedCompOffs extends StatefulWidget {
  @override
  State<RejectedCompOffs> createState() => _RejectedCompOffsState();
}

class _RejectedCompOffsState extends State<RejectedCompOffs> {
