...
class AtWorkManagerPie extends StatefulWidget {
  final List<dynamic> attendaceViewModel;
  final bool isLoading;

  AtWorkManagerPieState createState() => AtWorkManagerPieState();

  AtWorkManagerPie(this.attendaceViewModel, this.isLoading);
}

class AtWorkManagerPieState extends State<AtWorkManagerPie> {
  int present = 0;
  int absent = 0;
  int leave = 0;
  int checkOut = 0;
  ...
  void calculateNumber() {
    ...
    print(
        'At Work Data Couunnnntttttttttt: ${widget.attendaceViewModel.length}');
