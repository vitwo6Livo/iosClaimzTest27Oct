...
class RejectedCompOffManager extends StatefulWidget {
  RejectedCompOffManagerState createState() => RejectedCompOffManagerState();
}

class RejectedCompOffManagerState extends State<RejectedCompOffManager> {
  ...
  Widget build(BuildContext context) {
    final provider =
        Provider.of<CompOffManagerViewModel>(context).rejectedCompOffData;
    final themeProvider = Provider.of<ThemeProvider>(context);
    // TODO: implement build
    return provider.isEmpty
        ? Center(
            child: Text(
              'No Comp-Offs Rejected',
