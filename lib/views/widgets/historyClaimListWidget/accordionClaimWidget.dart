...
// class AccordionClaim extends StatefulWidget {
//   Map arguments;
//   AccordionClaim(Map this.arguments, {Key? key}) : super(key: key);

//   @override
//   State<AccordionClaim> createState() => _AccordionClaimState();
// }

// class _AccordionClaimState extends State<AccordionClaim> {
//   int role = 0;
...
//     return ChangeNotifierProvider<ClaimzFormIndividualViewModel>(
...
//             case Status.ERROR:
//               return Center(
//                 child: Text(value.claimz_user_limit.message.toString()),
//               );
//             case Status.COMPLETED:
//               Future.delayed(Duration(milliseconds: 300), () {
//                 setState(() {
//                   status_travel =
//                       value.claimz_user_limit!.data!.travelStatus.toString();
//                   status_food =
//                       value.claimz_user_limit!.data!.foodStatus.toString();
//                   status_incidental = value
//                       .claimz_user_limit!.data!.incidentalStatus
//                       .toString();

//                   _distance_in_km_val = value
//                       .claimz_user_limit!.data!.travelData.distance
//                       .toString();
//                   _travel_name_of_serviceprovider_val = value
//                       .claimz_user_limit!.data!.travelData.serviceProvider
//                       .toString();
//                   _travel_basic_amt_val = value
//                       .claimz_user_limit!.data!.travelData.basicAmount
//                       .toString();
//                   _travel_gst_amt_val = value
//                       .claimz_user_limit!.data!.travelData.gSTAmount
//                       .toString();
//                   _travel_total_amt_val = value
//                       .claimz_user_limit!.data!.travelData.totalAmount
//                       .toString();

//                   _food_name_of_serviceprovider_val = value
//                       .claimz_user_limit!.data!.foodData.serviceProvider
//                       .toString();
//                   _food_basic_amt_val = value
//                       .claimz_user_limit!.data!.foodData.basicAmount
//                       .toString();
//                   _food_gst_amt_val = value
//                       .claimz_user_limit!.data!.foodData.gSTAmount
//                       .toString();
//                   _food_total_amt_val = value
//                       .claimz_user_limit!.data!.foodData.totalAmount
//                       .toString();
//                   _food_gst_no_val =
//                       value.claimz_user_limit!.data!.foodData.gSTNo.toString();
//                   // _food_bill_no_val =  value.claimz_user_limit!.data!.foodData.bill_no.toString();

//                   _ie_name_of_serviceprovider_val = value
//                       .claimz_user_limit!.data!.incidentData.serviceProvider
//                       .toString();
//                   _ie_basic_amt_val = value
//                       .claimz_user_limit!.data!.incidentData.basicAmount
//                       .toString();
//                   _ie_gst_amt_val = value
//                       .claimz_user_limit!.data!.incidentData.gSTAmount
//                       .toString();
//                   _ie_total_amt_val = value
//                       .claimz_user_limit!.data!.incidentData.totalAmount
//                       .toString();
...
//                         .claimz_user_limit.data!.travel![0].limitPerKm
//                         .toString());
//                   });
...
//                         .claimz_user_limit.data!.travel![1].limitPerKm
//                         .toString());
//                   });
//                 } else if (myYears1 == "3") {
//                   setState(() {
//                     limit_travel_public_transport = double.parse(value
//                         .claimz_user_limit.data!.travel![2].limitPerKm
//                         .toString());
//                   });
//                 } else if (myYears1 == "4") {
//                   setState(() {
//                     limit_travel_own_car_p = double.parse(value
//                         .claimz_user_limit.data!.travel![3].limitPerKm
//                         .toString());
//                   });
//                 } else if (myYears1 == "5") {
//                   setState(() {
//                     limit_travel_company_vehical = double.parse(value
//                         .claimz_user_limit.data!.travel![4].limitPerKm
//                         .toString());
//                   });
//                 }

//                 setState(() {
//                   limit_food = double.parse(
//                       value.claimz_user_limit.data!.food![0].limit.toString());
//                   limit_incidental = double.parse(value
//                       .claimz_user_limit.data!.incidental![0].limit
//                       .toString());
//                 });
//               });
...
//                 children: [
//                   Container(
//                     height: SizeVariables.getHeight(context) * 0.69,
//                     // color: Colors.red,
//                     child: ListView(
//                       children: [
...
//         "travel_GST": _travel_gst_amt.text == '' ? '' : _travel_gst_amt.text,
//         "travel_basic": _travel_total_amt.text,
//         "travel_total": _travel_total_amt.text,
//         "travel_service_provider": _travel_name_of_serviceprovider.text,
//         "travel_GST_no": "",
...
//         "doc_no": widget.arguments["doc_no"],
//         "from": "",
//         "food_service_provider": _food_name_of_serviceprovider.text,
//         "food_GST_no": _food_gst_no.text,
//         "food_GST": _food_gst_amt.text,
//         "food_basic": _food_basic_amt.text,
//         "food_total": _food_total_amt.text,
//       };
...
//       Map<String, String> request_data = {
//         "doc_no": widget.arguments["doc_no"],
//         "incidental_GST_no": _ie_gst_no.text,
//         "incidental_GST": _ie_gst_amt.text,
//         "incidental_basic": _ie_basic_amt.text,
//         "incidental_total": _ie_total_amt.text,
//         "from": "",
//       };
//       if (_ie_file == null) {
//         _errorVal(context);
