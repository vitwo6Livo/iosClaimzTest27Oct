...
// class RejectedManagerIncidents extends StatelessWidget {
//   bool pendingIncidental = false;

//   @override
//   Widget build(BuildContext context) {
//     final provider = Provider.of<ManagerIncidentalViewModel>(context).rejected;
...
//                                             Expanded(
//                                               child: Text(
//                                                   'Purpose: ${provider[index]['purpose']}',
//                                                   style: Theme.of(context)
//                                                       .textTheme
//                                                       .bodyText1!
//                                                       .copyWith(
