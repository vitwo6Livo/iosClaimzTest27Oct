...
class CommonHolidays extends StatelessWidget {
  List<Map<String, dynamic>> commonHolidays;

  CommonHolidays(this.commonHolidays);
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
        ...
        child: ListView.builder(
                            ...
                            children: [
                              ...
                              Text(
                                  '${DateFormat('EEE').format(DateTime.parse(
                                    ...
                                    //         ['holidays'][index]
                                    //     ['holiday_date'],
                                    commonHolidays[index]['holiday_date'],
                                  ))}, ${commonHolidays[index]['holiday_date']}',
                                  style: Theme.of(context)
                                      .textTheme
                                      .bodyText1!
            ...
            itemCount: commonHolidays.length));
  }
}
