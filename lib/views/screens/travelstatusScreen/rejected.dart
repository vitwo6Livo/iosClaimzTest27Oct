...
class Rejected extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final provider = Provider.of<TravelViewModel>(context).rejected;
    ...
    return Container(
      ...
      child: provider.isEmpty
          ? Center(
              child: Text('No Rejected Travel Claims',
                            ...
                            Row(
                              children: [
                                ...
                                Padding(
                                  padding: EdgeInsets.only(
                                    left:
                                        SizeVariables.getWidth(context) * 0.44,
                                    top:
                                        SizeVariables.getHeight(context) * 0.02,
                                  ),
                                  child: Container(
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      child: FittedBox(
                                        fit: BoxFit.contain,
                                        child: Text(
                                          provider[index]['to_time'].toString(),
                                          style: Theme.of(context)
                                              .textTheme
                                              .bodyText1!
                                              .copyWith(
