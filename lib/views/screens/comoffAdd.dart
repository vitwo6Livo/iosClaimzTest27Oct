...
class CompoffAdd extends StatefulWidget {
  // const CompoffScreen({Key? key}) : super(key: key);

  final String fromDate;
  final String toDate;

  CompoffAdd(this.fromDate, this.toDate);

  @override
  State<CompoffAdd> createState() => _CompoffAddState();
}

class _CompoffAddState extends State<CompoffAdd> {
                  ...
                  child: Column(
                    ...
                    children: [
                      Expanded(
                          child: Center(
                        child: Text(
                          'Comp Off to be applied in lieu of Leave/Holiday/Weekend that you have worked on. Please ensure that you have enter the time along with the reason.',
