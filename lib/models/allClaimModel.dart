class allClaimModel {
  ...
  allClaimModel({this.status, this.data});

  allClaimModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    if (json['data'] != null) {
      data = <Data>[];
      json['data'].forEach((v) {
...
class Data {
  ...
  dynamic? bill_no;
  dynamic? gst_no;
  dynamic? basic_amount;
  dynamic? gst_amount;
  dynamic? attachment;
  dynamic? claim_amount;
  dynamic? approval_log;
  Data(
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    gst_no = json['gst_no'];
    approval_log = json['approval_log'];
    basic_amount = json['basic_amount'];
    gst_amount = json['gst_amount'];
    attachment = json['attachment'];
    tsId = json['ts_id'];
    service_provider = json['service_provider'];
    incedental_form_id = json['incedental_form_id'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['approval_log'] = this.approval_log;
    data['basic_amount'] = this.basic_amount;
    data['gst_amount'] = this.gst_amount;
    data['gst_no'] = this.gst_no;
    data['attachment'] = this.attachment;
    data['service_provider'] = this.service_provider;
    ...
    data['status'] = this.status;
    data['incedental_form_id'] = this.incedental_form_id;
    ...
    data['claim_amount'] = this.claim_amount;
    return data;
  }
}
